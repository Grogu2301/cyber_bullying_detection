...
from Cyberbullying.entity.config_entity import (DataIngestionConfig,DataTransformationConfig)
from Cyberbullying.entity.artifact_entity import (DataIngestionArtifacts,DataTransformationArtifacts)
