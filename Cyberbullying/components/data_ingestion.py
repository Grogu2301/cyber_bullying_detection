...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            imbalanced_data_file_path, labeled_data_file_path = self.unzip_and_clean()

            logging.info("Unzipped file and split into train and valid")

            data_ingestion_artifacts = DataIngestionArtifacts(imbalanced_data_file_path=imbalanced_data_file_path,
